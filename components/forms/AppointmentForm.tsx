...
export const AppointmentForm = ({
  ...
  async function onSubmitNewAppointment(values: z.infer<typeof AppointmentFormValidation>) {
    setIsLoading(true);
    let status;
    switch (type) {
      case "schedule":
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmitNewAppointment)} className="flex-1 space-y-6">
        {type === "create" && (
